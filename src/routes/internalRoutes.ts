...
import type { SupportRequest, SupportSession } from '../services/support/SupportTypes';
...
export function setupInternalRoutes(app: express.Application, services: DocumentServices): void {
  ...
  router.get('/internal/documents/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
      const document = await services.documentation.getDocument(id);
  ...
  router.put('/internal/documents/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const updated = await services.documentation.updateDocument(id, updates);
   ...
   */
  router.post('/internal/documents/:id/vote', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
      const { vote, validatorAddress } = req.body;
  ...
  router.get('/internal/forum/threads/:id', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
      const thread = await services.forum.getThread(id);
  ...
  router.post('/internal/forum/threads', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const thread: ForumThread = req.body;
   ...
   */
  router.get('/internal/support/stats', async (req: Request, res: Response, next: NextFunction) => {
    try {
   ...
   */
  router.post('/internal/support/sessions/:sessionId/assign', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { sessionId } = req.params;
      const { volunteerId } = req.body;

      await services.support.assignVolunteer(sessionId, volunteerId);
  ...
  router.post('/internal/forum/posts/:id/vote', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
      const { isUpvote, voterAddress } = req.body;
   ...
   */
  router.get('/internal/forum/stats', async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  router.get('/internal/support/sessions/:sessionId', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { sessionId } = req.params;
      const session = await services.support.getSessionDetails(sessionId);
  ...
  router.post('/internal/support/sessions/:sessionId/messages', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      await services.support.sendMessage(sessionId, sender, content);
  ...
  router.post('/internal/support/sessions/:sessionId/close', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      await services.support.resolveSession(sessionId, resolution);
  ...
  router.put('/internal/support/volunteers/:address/status', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      await services.support.updateVolunteerStatus(address, status);
  ...
  router.get('/internal/participation/:userId/score', async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const score = await services.participation.getUserScore(userId);
   ...
   */
  router.get('/internal/health', async (req: Request, res: Response, next: NextFunction) => {
    try {
      const health = {
        status: 'healthy',
        services: {
